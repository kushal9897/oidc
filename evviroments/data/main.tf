...
module "ec2" {
  ...
  root_volume_size = 50  # Larger for production
  ...
  user_data = <<-EOF
    ...
    echo "<h1>Production Environment - ${local.project}</h1>" > /var/www/html/index.html
    ...
    echo "<p>⚠️ Production System - Handle with Care</p>" >> /var/www/html/index.html
  EOF
